...
public class EntityControlledVehiclePhysics : PhysicsBehaviorBaseVehicle, IPhysicsTickable, IRemotePhysics
{
    ...
    public EntityControlledVehiclePhysics(Entity entity) : base(entity) { }
    ...
    public void RemoteMotionAndCollision(EntityPos pos, float dtFactor)
    {
        ...
        vCollisionTester.ApplyTerrainCollision(entity, pos, dtFactor, ref newPos, 0, 0);
    ...
    public void ApplyTests(EntityPos pos, EntityControls controls, float dt, bool remote)
    {
        ...
        if (!remote)
        {
            ...
            vCollisionTester.ApplyTerrainCollision(entity, pos, dtFactor, ref newPos, 0, CollisionYExtra);
        ...
        Cuboidd testedEntityBox = vCollisionTester.entityBox;
    ...
    public virtual void OnPhysicsTick(float dt)
    {
        ...
        vCollisionTester.AssignToEntity(this, pos.Dimension);
    ...
    public void HandleSneaking(EntityPos pos, EntityControls controls, float dt)
    {
        ...
        if (!vCollisionTester.IsColliding(entity.World.BlockAccessor, sneakTestCollisionbox, testPosition)) return;
        ...
        if (!vCollisionTester.IsColliding(entity.World.BlockAccessor, sneakTestCollisionbox, testPosition))
        {
    ...
    public bool TryStep(EntityPos pos, Vec3d moveDelta, float dtFac, Cuboidd steppableBox, Cuboidd entityCollisionBox)
    {
        ...
        bool canStep = !vCollisionTester.IsColliding(entity.World.BlockAccessor, entity.CollisionBox, stepPos, false);

        if (canStep)
        {
            pos.Y += stepUpSpeed * dtFac;
            vCollisionTester.ApplyTerrainCollision(entity, pos, dtFac, ref newPos);
            return true;
        }
    ...
    public Cuboidd FindSteppableCollisionBox(Cuboidd entityCollisionBox, double motionY, Vec3d walkVector)
    {
        ...
        CachedCuboidListFaster blocks = vCollisionTester.CollisionBoxList;
        ...
        for (int i = 0; i < maxCount; i++)
        {
            ...
            EnumIntersect intersect = VehicleCollisionTester.AabbIntersect(collisionBox, entityCollisionBox, walkVector);
    ...
    public void AdjustCollisionBoxToAnimation(float dtFac)
    {
        ...
        if (Math.Abs(motionX) > 0.00001 || Math.Abs(motionZ) > 0.00001)
        {
            ...
            vCollisionTester.ApplyTerrainCollision(entity, posMoved, dtFac, ref newPos);
    ...
    protected void callOnEntityInside()
    {
        ...
        Cuboidd entityBox = vCollisionTester.entityBox;
        entityBox.SetAndTranslate(entity.CollisionBox, pos.X, pos.Y, pos.Z);

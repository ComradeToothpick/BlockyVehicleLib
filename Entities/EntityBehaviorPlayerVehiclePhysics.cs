...
/// </code></example>
[DocumentAsJson]
public class EntityBehaviorPlayerVehiclePhysics : EntityControlledVehiclePhysics, IRenderer, IRemotePhysics
{
    ...
    public EntityBehaviorPlayerVehiclePhysics(Entity entity) : base(entity)
    {
    ...
    public bool TryStepSmooth(EntityControls controls, EntityPos pos, Vec2d walkVec, float dtFac, List<Cuboidd> steppableBoxes, Cuboidd entityCollisionBox)
    {
        ...
        foreach (Cuboidd steppableBox in steppableBoxes)
        {
            ...
            bool canStep = !vCollisionTester.IsColliding(entity.World.BlockAccessor, col, stepPos, false);
